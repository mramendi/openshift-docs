...
* You can use the {OCP} web console *Developer* perspective to create Tekton resources, view logs of pipeline runs, and manage pipelines in your {OCP} namespaces.
...
* For information on installing {pipelines-shortname}, see xref:../pipelines/installing-pipelines.adoc#installing-pipelines[Installing {pipelines-shortname}].
* For more details on creating custom CI/CD solutions, see xref:../pipelines/creating-applications-with-cicd-pipelines.adoc#creating-applications-with-cicd-pipelines[Creating CI/CD solutions for applications using {pipelines-shortname}].
